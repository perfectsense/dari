...
public class PhraseIndexTest extends AbstractTest {
    ...
    public void testPhrase() {
        ...
        PhraseIndexModel expected = PhraseIndexModel.getInstance(db);
        expected.testString = test;
        expected.save();

        PhraseIndexModel actual = Query.from(PhraseIndexModel.class).using(db).where("testString matches ?", test).first();
        ...
        PhraseIndexModel actual2 = Query.from(PhraseIndexModel.class).using(db).where("testString matches ?", "develop").first();
        ...
        PhraseIndexModel actual1 = Query.from(PhraseIndexModel.class).using(db).where("testString matches ?", qp).first();
        ...
        PhraseIndexModel actual4 = Query.from(PhraseIndexModel.class).using(db).where("testString matches ?", qp).first();
        ...
        PhraseIndexModel actual5 = Query.from(PhraseIndexModel.class).using(db).where("testString matches ?", qp).first();
        assertThat("actual5 notnull", actual5, is(nullValue()));

        qp.setPhrase("Develop Astronomers");
        qp.setSlop(2.0f);
        PhraseIndexModel actual6 = Query.from(PhraseIndexModel.class).using(db).where("testString matches ?", qp).first();
        ...
        qp.setSlop(3.0f);
        PhraseIndexModel actual7 = Query.from(PhraseIndexModel.class).using(db).where("testString matches ?", qp).first();
        ...
        PhraseIndexModel expected2 = PhraseIndexModel.getInstance(db);
        ...
        qp.setSlop(1.0f);
        qp.setBoost(10.0f);
        PhraseIndexModel actual8 = Query.from(PhraseIndexModel.class).using(db).where("testString matches ?", qp).
